class Role < ActiveRecord::Base
  ...
  enumerize :permissions, in: [
    ...
    'order__read', 'order__history', 'order__mark_as_accepted', 'order__mark_as_declined', 'order__mark_as_delivered', 'order__mark_as_cancelled', 'order__update_placed', 'order__update_accepted', 'order__update_declined', 'order__update_delivered', 'order__update_cancelled', 'order__add_attachment', 'order__pay',
    'kitchen__create', 'kitchen__update', 'kitchen__dashboard', 'kitchen__import', 'kitchen__history', 'kitchen__reset_inventory',
