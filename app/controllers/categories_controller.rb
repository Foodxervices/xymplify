class CategoriesController < ApplicationController
  ...
  def index
    ...
    @food_items = @food_items.includes(:taggings)
                             .select("food_items.id, cached_tag_list, category_name, category_priority")
                             .order("category_priority, cached_tag_list ASC")
  ...
  def by_supplier
    init
    @food_items = @food_items.select("food_items.id, s.name as supplier_name, s.priority, category_name, category_priority")
                             .order("s.priority, s.name, category_priority ASC")
  ...
  def init
    ...
    @food_items = @food_item_filter.result
                                 ...
                                 .joins("LEFT JOIN (SELECT id, name as category_name, priority as category_priority
