...
Role.create([
  ...
  { name: 'Kitchen Manager', permissions: ['food_item__read', 'food_item__order', 'restaurant__dashboard', 'restaurant__read', 'supplier__read', 'user_role__read', 'order__read', 'order__mark_as_shipped', 'order__mark_as_cancelled', 'order__update_placed'] }
])
puts "==== End ===="