...
puts "==== Create Role ===="
Role.create([
  { name: 'Owner', permissions: ['food_item__manage', 'inventory__read', 'inventory__update', 'restaurant__manage', 'supplier__manage', 'user_role__manage', 'kitchen__dashboard', 'kitchen__import', 'order__read', 'order__history', 'order__mark_as_accepted', 'order__mark_as_declined', 'order__mark_as_delivered', 'order__mark_as_cancelled', 'order__update_placed', 'order__update_delivered', 'order__update_cancelled', 'message__read', 'message__create', 'message__update', 'message__destroy']},
